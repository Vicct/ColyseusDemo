...
{
    [SerializeField]private static ColyseusClient _client = null;
    [SerializeField]private static MenuManager _menuManager = null;
    [SerializeField]private static ColyseusRoom<MyRoomState> _room = null;
